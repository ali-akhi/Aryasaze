                        ...
                        <div class="tableBody">
                            <div class="table-responsive">
                                <table class="table table-hover dashboard-task-infos">
                                    ...
                                    <tbody>
                                    <x-dashboard.line-order-card img="/dashboard/images/user1.jpg" name="آرش خادلو"
                                                                 product="آیفون ایکس" status="قرار داده شده" count="2"
                                                                 color="bg-green" progress="l-bg-green" width="62"/>
                                    <x-dashboard.line-order-card img="/dashboard/images/user2.jpg" name="آرش خادملو"
                                                                 product="پیکسل 2" status="ارسال شده" count="1"
                                                                 color="l-bg-purple" progress="l-bg-purple" width="40"/>
                                    <x-dashboard.line-order-card img="/dashboard/images/user3.jpg" name="آرش خادملو"
                                                                 product="وان پلاس" status="در انتظار" count="2"
                                                                 color="l-bg-orange" progress="l-bg-orange" width="72"/>
                                    <x-dashboard.line-order-card img="/dashboard/images/user4.jpg" name="آرش خادملو"
                                                                 product="Galaxy" status="تحویل داده شده" count="3"
                                                                 color="l-bg-cyan" progress="l-bg-cyan" width="95"/>
                                    <x-dashboard.line-order-card img="/dashboard/images/user5.jpg" name="آرش خادملو"
                                                                 product="موتو زد2" status="قرار داده شده" count="4"
                                                                 color="bg-green" progress="l-bg-green" width="87"/>
                                    <x-dashboard.line-order-card img="/dashboard/images/user6.jpg" name="آرش خادملو"
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="recent-comment">
                                <x-dashboard.recent-comment img="/dashboard/images/user6.jpg" name="آرش خادملو"
                                                            date="1 سات پیش"
                                                            content="لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ. "/>
                                <x-dashboard.recent-comment img="/dashboard/images/user4.jpg" name="آرش خادملو"
                                                            date="دیروز"
                                                            content="لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ. "/>
                                <x-dashboard.recent-comment img="/dashboard/images/user3.jpg" name="آرش خادملو"
                                                            date="10-02-2018 10:25"
                                                            content="لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ. "/>
                                <x-dashboard.recent-comment img="/dashboard/images/user7.jpg" name="آرش خادملو"
                                                            date="15-03-2018 09:15"
                                                            content="لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ. "/>
                                <x-dashboard.recent-comment img="/dashboard/images/user9.jpg" name="آرش خادملو"
                                                            date=" 11-04-2018 11:07"
                                                            content="لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ. "/>
                                <x-dashboard.recent-comment img="/dashboard/images/user1.jpg" name="آرش خادملو"
                                                            date="1 سات پیش"
                                                            content="لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ. "/>
                                <x-dashboard.recent-comment img="/dashboard/images/user8.jpg" name="آرش خادملو"
                                                            date="دیروز"
                                                            content="لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ. "/>
                                <x-dashboard.recent-comment img="/dashboard/images/user6.jpg" name="آرش خادملو"
                                                            date="1 سات پیش"
