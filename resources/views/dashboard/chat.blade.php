                                ...
                                <div class="tab-content">
                                    <div id="chat_user">
                                        <ul class="chat-list list-unstyled m-b-0">
                                            <x-dashboard.chat-list-item active="active" img="/dashboard/images/user1.jpg" name="آرش خادملو"
                                                                        icon="offline" lastSeen="7 دقیقه پیش" />
                                            <x-dashboard.chat-list-item img="/dashboard/images/user2.jpg" name="آرش خادملو"
                                                                        icon="offline" lastSeen="آنلاین" />
                                            <x-dashboard.chat-list-item img="/dashboard/images/user3.jpg" name="آرش خادملو"
                                                                        icon="online" lastSeen="آنلاین" />
                                            <x-dashboard.chat-list-item img="/dashboard/images/user4.jpg" name="آرش خادملو"
                                                                        icon="online" lastSeen="آنلاین" />
                                            <x-dashboard.chat-list-item img="/dashboard/images/user5.jpg" name="آرش خادملو"
                                                                        icon="online" lastSeen="آنلاین" />
                                            <x-dashboard.chat-list-item img="/dashboard/images/user6.jpg" name="آرش خادملو"
